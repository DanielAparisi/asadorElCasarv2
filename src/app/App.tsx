...
const LoginRoute = lazy(() =>
  import('../features/auth/components/ProtectedRoutes').then((m) => ({ default: m.LoginRoute })),
)
const AdminRoute = lazy(() =>
  import('../features/auth/components/ProtectedRoutes').then((m) => ({ default: m.AdminRoute })),
)
